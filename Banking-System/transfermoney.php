...
<div class="container">
        ...
        <br>
            <div class="row">
                ...
                ?>
                    <tr style="color : LightGray;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #909497  ;"><b>Transact</b></button></a></td> 
                    </tr>
                <?php
                    }
                ?>
         ...
         <footer class="text-center mt-5 py-2">
            <p style="color : LightGray;">&copy 2021. Made by <b>SHAMITA PHUTANE</b> <br> THE SPARKS FOUNDATION PROJECT</p>
        </footer>
